...
# ===================== RUN BUTTON =====================
if st.button("🚀 Run / Update Analysis", type="primary", use_container_width=True):
    ...
    st.info("👆 Click the big blue **Run / Update Analysis** button above to generate results and charts.")
